...
\begin{figure}
	    \centering
		\includegraphics[width=1.5\textwidth]{BIRTH_DATA_ACF_PLOT.png}
...
\begin{figure}[bp!]
	    \centering
		\includegraphics[width=1.5\textwidth]{SHAMPOO_DATA_ACF_PLOT.png}
...
\begin{figure}[bp!]
	    \centering
		\includegraphics[width=1.5\textwidth]{MALARIA_DATA_ACF_PLOT.png}
