...
\begin{figure}%
	    \centering
	    \subfloat[TREND PLOT FOR BIRTHS]{\includegraphics[scale=0.3]{Birth_data_Trend_plot.png}}%
	    \qquad
	    \subfloat[AUTO-CORRELATION PLOT FOR BIRTHS]{\includegraphics[scale=0.3]{BIRTH_DATA_ACF_PLOT.png}}%
	    \qquad
	    \subfloat[TRENDLINE PLOT FOR BIRTHS]{\includegraphics[scale=0.3]{Birth_data_Trendline.png}}
...
\begin{figure}%
	    \centering
	    \subfloat[TREND PLOT FOR SHAMPOO SALES]{\includegraphics[scale=0.3]{Shampoo_data_Trend_plot.png}}%
	    \qquad                                                                                                                                                                  \subfloat[AUTO-CORRELATION PLOT FOR SHAMPOO SALES]{\includegraphics[scale=0.3]{SHAMPOO_DATA_ACF_PLOT.png}}%
	    \qquad                                                                                                                                                                  \subfloat[TRENDLINE PLOT FOR SHAMPOO SALES]{\includegraphics[scale=0.3]{SHAMPOO_DATA_Trendline.png}}                                                                             \caption{PLOTS FOR BIRTH DATA}                                                                                                                                              \label{fig:2}
\end{figure}
...
\begin{figure}[bp!]
	    \centering
	    \subfloat[TREND PLOT FOR MALARIA DATA]{\includegraphics[scale=0.3]{Malaria_Trend_plot.png}}%
	    \qquad
	    \subfloat[AUTO-CORRELATION PLOT FOR MALARIA DATA]{\includegraphics[scale=0.3]{MALARIA_DATA_ACF_PLOT.png}}
